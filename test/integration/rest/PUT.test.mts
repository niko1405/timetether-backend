...
// T e s t d a t e n
// -----------------------------------------------------------------------------
const geaendertesBuch: Omit<BuchUpdateType, 'datum'> & {
    datum: string;
} = {
...
const geaendertesBuchIdNichtVorhanden: Omit<BuchUpdateType, 'datum'> & {
    datum: string;
} = {
...
const veraltesBuch: Omit<BuchUpdateType, 'datum'> & {
    datum: string;
} = {
    isbn: '978-0-007-09732-6',
    rating: 1,
